...
class AddressBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create address_book" do
    assert_difference('AddressBook.count') do
      post address_books_url, params: { address_book: { email: @address_book.email, last_name: @address_book.last_name, name: @address_book.name, phone: @address_book.phone, user_id: @address_book.user_id } }
    end
  ...
  test "should update address_book" do
    patch address_book_url(@address_book), params: { address_book: { email: @address_book.email, last_name: @address_book.last_name, name: @address_book.name, phone: @address_book.phone, user_id: @address_book.user_id } }
